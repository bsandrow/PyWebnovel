...
class CoverPageTestCase(TestCase):
    def test_generate_cover_page(self):
        ...
        expected = (
            ...
            f'  <style type="text/css" title="cover-page-overrides">\n'
            f"    html, body, img, section, div {{\n"
            f"      height: 100vh;\n"
            f"      max-height: 100vh;\n"
            f"      display: block;\n"
            f"      margin: 0;\n"
...
class PyWebNovelJSONTestCase(TestCase):
    ...
    def test_generate(self):
        ...
        expected = (
            ...
            # -- chapters
            '"chapters": {'
            '"http://example.come/chapter-2": {"url": "http://example.come/chapter-2", "title": "Chapter 2. Example 2", "chapter_no": 2, "slug": null, "original_html": null, "html": null, "pub_date": null}, '
            '"http://example.come/chapter-1": {"url": "http://example.come/chapter-1", "title": "Chapter 1. Example 1", "chapter_no": 1, "slug": null, "original_html": null, "html": null, "pub_date": null}'
            "}, "
            # -- extra css
            '"extra_css": null}'
        ).encode("utf-8")
